...
import "./SushiAnimation.css";

export default function SushiAnimation() {
  useEffect(() => {
    animation();
  });
  return (
    <div className="sushi-animation">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1181"
        height="595"
        viewBox="0 0 1181 595"
      >
        <g id="sushi" transform="translate(-93 -86)">
          ...
          <g id="bowl" transform="translate(15 27)">
            ...
            <g
              id="Group_1"
              data-name="Group 1"
              transform="translate(78.005 66.923)"
            >
              <path
                id="Path_1"
                data-name="Path 1"
              ...
              <path
                id="Path_2"
                data-name="Path 2"
                d="M429,273s-3.055,25,175,25,175-25,175-25"
          ...
          <path
            ...
            transform="translate(927.733 214.295) rotate(43)"
            fill="#1f271b"
          />
          <path
            id="chopstick-01"
            d="M6.3,259.738V0c5.983,0,6.3,14.393,6.3,14.393S9.984,242.467,8.608,251.987c-1,6.941-1.772,7.881-2.115,7.881a.248.248,0,0,1-.193-.13Zm-2.311-7.751C2.611,242.467,0,14.393,0,14.393S.315,0,6.3,0V259.738a.248.248,0,0,1-.2.13c-.341,0-1.11-.94-2.113-7.881Z"
            transform="matrix(0.848, 0.53, -0.53, 0.848, 871.709, 186.214)"
            fill="#1f271b"
          />
          <g
            id="sushi-01"
          ...
          >
            ...
            <g
              id="Ellipse_3"
              data-name="Ellipse 3"
              transform="translate(317.094 80.547)"
              fill="#fff"
              stroke="#707070"
              stroke-width="1"
            >
      ...
      <h1 className="heading">Your Sushi is Ready 😊</h1>
    </div>
  );
}
